...
class Scan(db.Model):
    ...
    exploitable_count = db.Column(db.Integer, default=0)
    ...
    def to_dict(self):
        return {
            ...
            "phase":            self.phase,
            "is_twin_scan":     self.is_twin_scan,
            "total_hosts":      self.total_hosts or 0,
            "total_open_ports": self.total_open_ports or 0,
            "total_vulns":      self.total_vulns or 0,
            ...
            "exploitable_count": self.exploitable_count or 0,
